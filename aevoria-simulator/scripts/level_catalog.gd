...
static func build_levels() -> Array:
	return [
		...
		},
		{
			...
			"objective": "Scan the deep-space situation table for asteroids (PGM) and comets (H2O), inspect the ones worth a closer look, and direct your ship to mine them.",
			"scene_path": "res://scenes/SituationTable.tscn",
		},
		{
			"id": "oligarch_prospecting_run",
			"kind": Kind.EXTRACTION,
			"faction_id": OLIGARCH_COMBINE,
			"title": "Prospecting Run",
			"objective": "Scan the deep-space situation table for asteroids (PGM) and comets (H2O), inspect the ones worth a closer look, and direct your ship to mine them.",
